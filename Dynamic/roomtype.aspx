<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="roomtype.aspx.cs" Inherits="Dynamic.roomtype" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel">
            <div class="records--header">
                ...
                <div class="actions" style="width: 100%;">
                    <asp:TextBox ID="txtSearch" CssClass="form-control" runat="server" placeholder="Өрөөний ангилалын нэр..."></asp:TextBox>
                    ...
                    <a href="#myModal" class="btn btn-rounded btn-warning" data-toggle="modal" onclick="addRow()" style="margin-left: 10px;">Шинэ өрөөний ангилал үүсгэх</a>
                </div>
            </div>
        </div>

        <div class="panel">
            <div class="records--list" data-title="Өрөөний ангилалын жагсаалт">
                ...
                <div id="recordsListView_wrapper" class="dataTables_wrapper no-footer">
                    <div class="table-responsive">
                        <table id="recordsListView" class="dataTable no-footer" aria-describedby="recordsListView_info" style="font-size: 11px; width: 100%;" role="grid">
                            <thead>
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="recordsListView" rowspan="1" colspan="1" aria-label="Өрөөний ангилал">Өрөөний ангилал</th>
                                    <th class="not-sortable sorting_disabled" rowspan="1" colspan="1" aria-label="Actions">Үйлдэл</th>
                                </tr>
                            </thead>
                            <tbody>
                                <% foreach (System.Data.DataRow rw in dtRoomType.Rows)
                                    {
                                %>
                                <tr data-value="<%=rw["RoomTypePkID"].ToString() %>" role="row" onclick="OnRowClick(this)" class="odd">
                                        ...
                                        <div data-todoapp="item">
                                            <div class="todo--actions dropleft">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="#myModal" class="dropdown-item editRow" data-toggle="modal" data-id="<%=rw["RoomTypePkID"].ToString() %>">Засах</a>
                                                    <a href="#RemoveModal" class="dropdown-item deleteRow" data-toggle="modal" data-todoapp="del:item" data-id="<%=rw["RoomTypePkID"].ToString() %>">Устгах</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Өрөөний ангилалын бүртгэл</h5>      
    ...
    <div class="modal fade" id="RemoveModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5>Энэ өрөөний ангилалыг устгах уу ?</h5>
                </div>
    ...
    <script type = "text/javascript">
        ...
        function Save() {
            ...
            $.ajax({
                url: 'post.aspx/SaveRoomTypeInfo',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    type: act,
        ...
        function Delete() {
            $.ajax({
                url: 'post.aspx/DeleteRoomTypeInfo',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    id: selid
