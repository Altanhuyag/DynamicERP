<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="minibartype.aspx.cs" Inherits="Dynamic.minibartype" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel">
            <div class="records--header">
                ...
                <div class="actions" style="width: 100%;">
                    ...
                    <a href="#myModal" class="btn btn-rounded btn-warning" data-toggle="modal" onclick="addRow()" style="margin-left: 10px;">Мини баарны загвар үүсгэх</a>
                </div>
            </div>
        </div>
                ...
                <div id="recordsListView_wrapper" class="dataTables_wrapper no-footer">
                    <div class="table-responsive">
                        <table id="recordsListView" class="dataTable no-footer" aria-describedby="recordsListView_info" style="font-size: 11px; width: 100%;" role="grid">
                            ...
                            <tbody>
                                <% foreach (System.Data.DataRow rw in dtMiniBarType.Rows)
                                    {
                                %>
                                <tr data-value="<%=rw["MiniBarTypeInfoPkID"].ToString() %>" role="row" onclick="OnRowClick(this)" class="odd">
                                        ...
                                        <div data-todoapp="item">
                                            <div class="todo--actions dropleft">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="#myModal" class="dropdown-item editRow" data-toggle="modal" data-id="<%=rw["MiniBarTypeInfoPkID"].ToString() %>">Засах</a>
                                                    <a href="#RemoveModal" class="dropdown-item deleteRow" data-toggle="modal" data-todoapp="del:item" data-id="<%=rw["MiniBarTypeInfoPkID"].ToString() %>">Устгах</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
    ...
    <script type = "text/javascript">
        ...
        function Save() {
            ...
            $.ajax({
                url: 'post.aspx/SaveMiniBarTypeInfo',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    type: act,
        ...
        function Delete() {
            $.ajax({
                url: 'post.aspx/DeleteMiniBarTypeInfo',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    id: selid
