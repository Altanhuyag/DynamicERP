<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="roomgroup.aspx.cs" Inherits="Dynamic.roomgroup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel">
            <div class="records--header">
                <div class="title fa-object-group">
                    <h3 class="h3">Өрөөний бүлэг</h3>
                </div>
                <div class="actions" style="width: 100%;">
                    <asp:TextBox ID="txtSearch" CssClass="form-control" runat="server" placeholder="Өрөөний бүлгийн нэр..."></asp:TextBox>
                    ...
                    <a href="#myModal" class="btn btn-rounded btn-warning" data-toggle="modal" onclick="addRow()" style="margin-left: 10px;">Шинэ өрөөний бүлэг үүсгэх</a>
                </div>
            </div>
        </div>

        <div class="panel">
            <div class="records--list" data-title="Өрөөний бүлгийн жагсаалт">
                ...
                <div id="recordsListView_wrapper" class="dataTables_wrapper no-footer">
                    <div class="table-responsive">
                        <table id="recordsListView" class="dataTable no-footer" aria-describedby="recordsListView_info" style="font-size: 11px; width: 100%;" role="grid">
                            <thead>
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="recordsListView" rowspan="1" colspan="1" aria-label="Өрөөний бүлэг">Өрөөний бүлэг</th>
                                    <th class="not-sortable sorting_disabled" rowspan="1" colspan="1" aria-label="Actions">Үйлдэл</th>
                                </tr>
                            </thead>
                            <tbody>
                                <% foreach (System.Data.DataRow rw in dtRoomGroup.Rows)
                                    {
                                %>
                                <tr data-value="<%=rw["GroupPkID"].ToString() %>" role="row" onclick="OnRowClick(this)" class="odd">
                                        ...
                                        <div data-todoapp="item">
                                            <div class="todo--actions dropleft">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="#myModal" class="dropdown-item editRow" data-toggle="modal" data-id="<%=rw["GroupPkID"].ToString() %>">Засах</a>
                                                    <a href="#RemoveModal" class="dropdown-item deleteRow" data-toggle="modal" data-todoapp="del:item" data-id="<%=rw["GroupPkID"].ToString() %>">Устгах</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Өрөөний бүлгийн бүртгэл</h5>      
    ...
    <div class="modal fade" id="RemoveModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5>Энэ өрөөний бүлгийг устгах уу ?</h5>
                </div>
    ...
    <script type = "text/javascript">
        ...
        function Save() {
            ...
            if (nam == '') {
                swal('Анхааруулга', 'Өрөөний бүлгийн нэрээ оруулна уу !', 'warning');
                return;
            }
