...
namespace Dynamic
{
    public partial class roomgroup : System.Web.UI.Page
    {
        public static DataTable dtRoomGroup;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ds = SystemGlobals.DataBase.ExecuteQuery("sphtl_RoomGroupInfo_SEL", XML);
            dtRoomGroup = ds.Tables[0];
        }
