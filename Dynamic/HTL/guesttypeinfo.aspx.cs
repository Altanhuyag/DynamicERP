...
namespace Dynamic
{
    public partial class guesttypeinfo : System.Web.UI.Page
    {
        public static DataTable dtGuestInfo;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ds = SystemGlobals.DataBase.ExecuteQuery("sphtl_GuestTypeInfo_SEL", XML);
            dtGuestInfo = ds.Tables[0];
