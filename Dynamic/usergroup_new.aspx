<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="usergroup_new.aspx.cs" Inherits="Dynamic.usergroup_new" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class ="form-horizontal">
            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Хэрэглэгчийн эрх</label>
                        <div class="col-sm-4">
                       ...
                       <label class="col-sm-2 control-label">Ажиллах програм</label>
                        <div class="col-sm-4">
        ...
        <tbody>
            <% 
                System.Data.DataTable dt = Loan.Models.SystemGlobals.DataBase.ExecuteSQL("select * from smmWebMenuInfo where CreatedModuleID='WEB' and Len(MenuInfoCode)=2").Tables[0];
           ...
           <% System.Data.DataTable dts = Loan.Models.SystemGlobals.DataBase.ExecuteSQL("select * from smmWebMenuInfo where CreatedModuleID='WEB' and MenuInfoCode like '"+rw["MenuInfoCode"].ToString()+"%' and len(MenuInfoCode)>2").Tables[0];
            ...
            <%
                    ...
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-2">
                            <input id="Button1" type="button" class="btn btn-primary" value="Хадгалах" onclick="SaveForm();" />
                            <a href="usergroup.aspx" class="btn btn-default" type="submit">Буцах</a>
                        </div>
                    </div>
