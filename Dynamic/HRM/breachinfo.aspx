...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel">
            <div class="records--header">
                <div class="title fa-object-group">
                    <h3 class="h3">Арга хэмжээний төрлийн бүртгэл</h3>
                </div>
                <div class="actions" style="width: 100%;">
                    <a href="#myModal" class="btn btn-rounded btn-warning" data-toggle="modal" onclick="addRow()" style="margin-left: 10px;">Шинэ арга хэмжээний төрлийн бүртгэлийгүүсгэх</a>
                </div>
            </div>
        </div>

        <div class="panel">
            <div class="records--list" data-title="Арга хэмжээний төрлийн бүртгэлийн жагсаалт">
                ...
                <div id="recordsListView_wrapper" class="dataTables_wrapper no-footer">
                    <div class="table-responsive">
                        <table id="recordsListView" class="dataTable no-footer" aria-describedby="recordsListView_info" style="font-size: 11px; width: 100%;" role="grid">
                            <thead>
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="recordsListView" rowspan="1" colspan="1" aria-label="Хэлтэсийн код">Хэлтсийн код</th>
                                    <th class="not-sortable sorting_disabled" rowspan="1" colspan="1" aria-label="Actions">Үйлдэл</th>
                                </tr>
                            </thead>
                            <tbody>
                                <% foreach (System.Data.DataRow rw in dtBreachInfo.Rows)
                                    {
                                %>
                                <tr data-value="<%=rw["BreachPkID"].ToString() %>" role="row" onclick="OnRowClick(this)" class="odd">
                                    <td><%=rw["BreachName"].ToString() %></td>
                                    <td>
                                        <div data-todoapp="item">
                                            <div class="todo--actions dropleft">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="#myModal" class="dropdown-item editRow" data-toggle="modal" data-id="<%=rw["BreachPkID"].ToString() %>">Засах</a>
                                                    <a href="#RemoveModal" class="dropdown-item deleteRow" data-toggle="modal" data-todoapp="del:item" data-id="<%=rw["BreachPkID"].ToString() %>">Устгах</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Арга хэмжээний төрлийн бүртгэл</h5>      
                    ...
                    <p>
                        <div class="form-group">                                        
                            <div class="row">
                                <div class="col-md-12">
                                    <h5>Хэлтэсийн код</h5>
                                    <input class="form-control" type="text" id="txtBreachName" />
                                </div>          
                            </div>
                        </div>
                    </p>                                    
    ...
    <div class="modal fade" id="RemoveModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5>Энэ Арга хэмжээний төрлийн бүртгэлийг устгах уу ?</h5>
                </div>
    ...
    <script type = "text/javascript">
        ...
        $('.editRow').on('click', function () {
            ...
            $('#txtBreachName').val(document.getElementById("recordsListView").rows[rid].cells[0].innerHTML);
        ...
        function Save() {
            ...
            $.ajax({
                url: '../post.aspx/SaveHRMBreachInfo',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    adding: act,
        ...
        function Delete() {
            $.ajax({
                url: '../post.aspx/DeleteHRMBreachInfo',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    id: selid
