<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="degreeinfo.aspx.cs" Inherits="Dynamic.degreeinfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel">
            <div class="records--header">
                <div class="title fa-object-group">
                    <h3 class="h3">Эрдмийн зэргийн мэдээлэл</h3>
                </div>
                <div class="actions" style="width: 100%;">
                    <a href="#myModal" class="btn btn-rounded btn-warning" data-toggle="modal" onclick="addRow()" style="margin-left: 10px;">Эрдмийн зэргийн бүртгэл үүсгэх</a>
                </div>
            </div>
        </div>

        <div class="panel">
            <div class="records--list" data-title="Эрдмийн зэргий бүртгэлийн жагсаалт">
                ...
                <div id="recordsListView_wrapper" class="dataTables_wrapper no-footer">
                    <div class="table-responsive">
                        <table id="recordsListView" class="dataTable no-footer" aria-describedby="recordsListView_info" style="font-size: 11px; width: 100%;" role="grid">
                            <thead>
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="recordsListView" rowspan="1" colspan="1" aria-label="Эрдмийн зэргийн мэдээллийн нэр">Эрдмийн зэргийн мэдээллийн нэр</th>
                            ...
                            <tbody>
                                <% foreach (System.Data.DataRow rw in dtDegreeInfo.Rows)
                                    {
                                %>
                                <tr data-value="<%=rw["DegreeInfoPkID"].ToString() %>" role="row" onclick="OnRowClick(this)" class="odd">
                                        ...
                                        <div data-todoapp="item">
                                            <div class="todo--actions dropleft">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="#myModal" class="dropdown-item editRow" data-toggle="modal" data-id="<%=rw["DegreeInfoPkID"].ToString() %>">Засах</a>
                                                    <a href="#RemoveModal" class="dropdown-item deleteRow" data-toggle="modal" data-todoapp="del:item" data-id="<%=rw["DegreeInfoPkID"].ToString() %>">Устгах</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Эрдмийн зэргийн мэдээлэл</h5>      
                ...
                <div class="modal-body">                                    
                    <p>
                        <div class="form-group">                                        
                            <div class="row">
                                <div class="col-md-12">
                                    <h5>Эрдмийн зэргийн мэдээлэл</h5>
                                    <input class="form-control" type="text" id="txtDegreeInfoName" />
                                </div>          
                            </div>
    ...
    <div class="modal fade" id="RemoveModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5>Энэ эрдмийн зэргийг устгах уу ?</h5>
                </div>
    ...
    <script type = "text/javascript">
        ...
        $('.editRow').on('click', function () {
            ...
            $('#txtDegreeInfoName').val(document.getElementById("recordsListView").rows[rid].cells[0].innerHTML);
        ...
        function Save() {
            var DegreeInfoName1 = $('#txtDegreeInfoName').val().trim();

            if (DegreeInfoName1 == '') {
                swal('Анхааруулга', 'Эрдмийн зэргийн мэдээллээ оруулна уу !', 'warning');
                return;
            }
            
            
            $.ajax({
                url: 'post.aspx/SaveHRMDegreeInfo',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    adding: act,
                    id: selid,
                    DegreeInfoName: DegreeInfoName1,
                }),
        ...
        function Delete() {
            $.ajax({
                url: 'post.aspx/DeleteHRMDegreeInfo',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    id: selid
