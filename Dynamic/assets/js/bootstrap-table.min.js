...
(function (e, t) {
    ...
    (function (l) {
        var i = 4;
        try {
            var g = l.fn.dropdown.Constructor.VERSION;
        ...
        var s = {
            ...
            r = {
                ...
                setFieldIndex: function (e) {
                    ...
                    for (var y = 0; y < e.length; y++)
                        for (var c = e[y], p = Array.isArray(c), h = 0, _iterator3 = p ? c : c[Symbol.iterator]() ; ;) {
                            var g;
                            if (p) {
                                if (h >= c.length) break;
                                g = c[h++]
            ...
            d = {
                ...
                buttonsAlign: 'right',
                buttonsPrefix: s.classes.buttonsPrefix,
        ...
        var p = function () {
            function t(o, a) {
                e(this, t), this.options = a, this.$el = l(o), this.$el_ = this.$el.clone(), this.timeoutId_ = 0, this.timeoutFooter_ = 0, this.init()
            }
            return o(t, [{
                key: 'init',
                value: function () {
                ...
                value: function () {
                    ...
                    if (this.$header = this.$el.find('>thead'), this.$header.length ? this.options.theadClasses && this.$header.addClass(this.options.theadClasses) : this.$header = l('<thead class="' + this.options.theadClasses + '"></thead>').appendTo(this.$el), this.$header.find('tr').each(function (e, t) {
                        ...
                        this.$el.find('>tbody>tr').each(function (t, o) {
                            var n = {};
                            n._id = l(o).attr('id'), n._class = l(o).attr('class'), n._data = r.getRealDataAttr(l(o).data()), l(o).find('>td').each(function (o, a) {
                                for (var s = +l(a).attr('colspan') || 1, d = +l(a).attr('rowspan') || 1, c = o; i[t] && i[t][c]; c++);
                                for (var h = c; h < c + s; h++)
                                    for (var g = t; g < t + d; g++) i[g] || (i[g] = []), i[g][h] = !0;
                                var p = e.columns[c].field;
                                n[p] = l(a).html().trim(), n['_' + p + '_id'] = l(a).attr('id'), n['_' + p + '_class'] = l(a).attr('class'), n['_' + p + '_rowspan'] = l(a).attr('rowspan'), n['_' + p + '_colspan'] = l(a).attr('colspan'), n['_' + p + '_title'] = l(a).attr('title'), n['_' + p + '_data'] = r.getRealDataAttr(l(a).data())
                            }), a.push(n)
                    ...
                    var e = this,
                        ...
                        a = 0; -1 !== i && (this.options.sortStable && this.data.forEach(function (e, t) {
                            ...
                            var s = r.getItemField(n, t, e.options.escape),
                                ...
                                c = r.calculateObjectValue(e.header, e.header.sorters[i], [s, d, n, a]);
                            return void 0 === c ? ((void 0 === s || null === s) && (s = ''), (void 0 === d || null === d) && (d = ''), e.options.sortStable && s === d && (s = n._position, d = a._position), l.isNumeric(s) && l.isNumeric(d)) ? (s = parseFloat(s), d = parseFloat(d), s < d ? -1 * o : s > d ? o : 0) : s === d ? 0 : ('string' != typeof s && (s = s.toString()), -1 === s.localeCompare(d) ? -1 * o : o) : e.options.sortStable && 0 === c ? o * (n._position - a._position) : o * c
                ...
                value: function () {
                    ...
                    }), o.push(this.constants.html.toobarDropdow[1], '</div>')), o.push('</div>'), (this.showToolbar || 2 < o.length) && this.$toolbar.append(o.join('')), t.showPaginationSwitch && this.$toolbar.find('button[name="paginationSwitch"]').off('click').on('click', l.proxy(this.togglePagination, this)), t.showFullscreen && this.$toolbar.find('button[name="fullscreen"]').off('click').on('click', l.proxy(this.toggleFullscreen, this)), t.showRefresh && this.$toolbar.find('button[name="refresh"]').off('click').on('click', l.proxy(this.refresh, this)), t.showToggle && this.$toolbar.find('button[name="toggle"]').off('click').on('click', function () {
                        e.toggleView()
                ...
                value: function (e) {
                    var t = e.currentTarget,
                        ...
                        a = l.trim(l(t).val());
                    this.options.trimOnSearch && l(t).val() !== a && l(t).val(a), a === this.searchText || (this.searchText = a, this.options.searchText = a, !o && (this.options.pageNumber = 1), this.initSearch(), o ? 'client' === this.options.sidePagination && this.updatePagination() : this.updatePagination(), this.trigger('search', a))
                }
            }, {
                key: 'initSearch',
                value: function () {
                    ...
                    if ('server' !== this.options.sidePagination) {
                        ...
                        this.data = o ? this.options.data.filter(function (e) {
                            for (var t in o)
                                if (Array.isArray(o[t]) && -1 === o[t].indexOf(e[t]) || !Array.isArray(o[t]) && e[t] !== o[t]) return !1;
                            return !0
                        }) : this.options.data, this.data = t ? this.data.filter(function (o, a) {
                            for (var p = 0; p < e.header.fields.length; p++)
                                if (e.header.searchables[p]) {
                                    var i = l.isNumeric(e.header.fields[p]) ? parseInt(e.header.fields[p], 10) : e.header.fields[p],
                                        n = e.columns[e.fieldsColumnsIndex[i]],
                                        s = void 0;
                                    if ('string' == typeof i) {
                                        s = o;
                                        for (var d = i.split('.'), c = 0; c < d.length; c++) null !== s[d[c]] && (s = s[d[c]])
                                    } else s = o[i];
                                    if (n && n.searchFormatter && (s = r.calculateObjectValue(n, e.header.formatters[p], [s, o, a], s)), 'string' == typeof s || 'number' == typeof s)
                ...
                value: function () {
                    ...
                    var o = [],
                        ...
                        u = this.getData(),
                        f = a.pageList;
                    if ('server' !== a.sidePagination && (a.totalRows = u.length), this.totalPages = 0, a.totalRows) {
                        if (a.pageSize === a.formatAllRows()) a.pageSize = a.totalRows, n = !0;
                        else if (a.pageSize === a.totalRows) {
                            var P = 'string' == typeof a.pageList ? a.pageList.replace('[', '').replace(']', '').replace(/ /g, '').toLowerCase().split(',') : a.pageList; -1 !== P.indexOf(a.formatAllRows().toLowerCase()) && (n = !0)
                        }
                    ...
                    var b = a.onlyInfoPagination ? a.formatDetailPagination(a.totalRows) : a.formatShowingRows(this.pageFrom, this.pageTo, a.totalRows);
                    if (o.push('<div class="' + this.constants.classes.pull + '-' + a.paginationDetailHAlign + ' pagination-detail">\n        <span class="pagination-info">\n        ' + b + '\n        </span>'), !a.onlyInfoPagination) {
                        ...
                        var C = ['<span class="' + this.constants.classes.paginationDropdown + '">\n          <button class="' + this.constants.buttonsClass + ' dropdown-toggle" type="button" data-toggle="dropdown">\n          <span class="page-size">\n          ' + (n ? a.formatAllRows() : a.pageSize) + '\n          </span>\n          ' + this.constants.html.dropdownCaret + '\n          </button>\n          ' + this.constants.html.pageDropdown[0]];
                        if ('string' == typeof a.pageList) {
                            var T = a.pageList.replace('[', '').replace(']', '').replace(/ /g, '').split(',');
                            f = [];
                            for (var m = T, y = Array.isArray(m), w = 0, _iterator9 = y ? m : m[Symbol.iterator]() ; ;) {
                                var v;
                                if (y) {
                                    if (w >= m.length) break;
                                    v = m[w++]
                                } else {
                                    if (w = m.next(), w.done) break;
                                    v = w.value
                                }
                                var k = v;
                                f.push(k.toUpperCase() === a.formatAllRows().toUpperCase() || 'UNLIMITED' === k.toUpperCase() ? a.formatAllRows() : +k)
                            }
                        }
                        f.forEach(function (e, o) {
                            if (!a.smartDisplay || 0 === o || f[o - 1] < a.totalRows) {
                                var i;
                                i = n ? e === a.formatAllRows() ? t.constants.classes.dropdownActive : '' : e === a.pageSize ? t.constants.classes.dropdownActive : '', C.push(r.sprintf(t.constants.html.pageDropdownItem, i, e))
                            }
                        }), C.push(this.constants.html.pageDropdown[1] + '</span>'), o.push(a.formatRecordsPerPage(C.join(''))), o.push('</span></div>'), o.push('<div class="' + this.constants.classes.pull + '-' + a.paginationHAlign + ' pagination">', r.sprintf(this.constants.html.pagination[0], r.sprintf(' pagination-%s', a.iconSize)), r.sprintf(this.constants.html.paginationItem, ' page-pre', a.paginationPreText)), this.totalPages < a.paginationSuccessivelySize ? (i = 1, d = this.totalPages) : (i = a.pageNumber - a.paginationPagesBySide, d = i + 2 * a.paginationPagesBySide), a.pageNumber < a.paginationSuccessivelySize - 1 && (d = a.paginationSuccessivelySize), d > this.totalPages && (d = this.totalPages), a.paginationSuccessivelySize > this.totalPages - i && (i = i - (a.paginationSuccessivelySize - (this.totalPages - i)) + 1), 1 > i && (i = 1), d > this.totalPages && (d = this.totalPages);
                        var x = e(a.paginationPagesBySide / 2),
                            S = function (e) {
                        ...
                        if (1 < i) {
                            var A = a.paginationPagesBySide;
                            for (A >= i && (A = i - 1), s = 1; s <= A; s++) o.push(S(s));
                            i - 1 === A + 1 ? (s = i - 1, o.push(S(s))) : i - 1 > A && (i - 2 * a.paginationPagesBySide > a.paginationPagesBySide && a.paginationUseIntermediate ? (s = e((i - x) / 2 + x), o.push(S(s, ' page-intermediate'))) : o.push(r.sprintf(this.constants.html.paginationItem, ' page-first-separator disabled', '...')))
                        }
                        for (s = i; s <= d; s++) o.push(S(s));
                        if (this.totalPages > d) {
                            var O = this.totalPages - (a.paginationPagesBySide - 1);
                            for (d >= O && (O = d + 1), d + 1 === O - 1 ? (s = d + 1, o.push(S(s))) : O > d + 1 && (this.totalPages - d > 2 * a.paginationPagesBySide && a.paginationUseIntermediate ? (s = e((this.totalPages - x - d) / 2 + d), o.push(S(s, ' page-intermediate'))) : o.push(r.sprintf(this.constants.html.paginationItem, ' page-last-separator disabled', '...'))), s = O; s <= this.totalPages; s++) o.push(S(s))
                        }
                    ...
                    var $ = -1 === ['bottom', 'both'].indexOf(a.paginationVAlign) ? '' : ' ' + this.constants.classes.dropup;
                    this.$pagination.last().find('.page-list > span').addClass($), a.onlyInfoPagination || (c = this.$pagination.find('.page-list a'), p = this.$pagination.find('.page-pre'), h = this.$pagination.find('.page-next'), g = this.$pagination.find('.page-item').not('.page-next, .page-pre'), a.smartDisplay && (1 >= this.totalPages && this.$pagination.find('div.pagination').hide(), (2 > f.length || a.totalRows <= f[0]) && this.$pagination.find('span.page-list').hide(), this.$pagination[this.getData().length ? 'show' : 'hide']()), !a.paginationLoop && (1 === a.pageNumber && p.addClass('disabled'), a.pageNumber === this.totalPages && h.addClass('disabled')), n && (a.pageSize = a.formatAllRows()), c.off('click').on('click', l.proxy(this.onPageListChange, this)), p.off('click').on('click', l.proxy(this.onPagePre, this)), h.off('click').on('click', l.proxy(this.onPageNext, this)), g.off('click').on('click', l.proxy(this.onPageNumber, this)))
                }
            }, {
                ...
                value: function (e, t) {
                    ...
                    if (!(-1 < r.findIndex(this.hiddenRows, e))) {
                        if (n = r.calculateObjectValue(this.options, this.options.rowStyle, [e, t], n), n && n.css)
                            ...
                            }(n.css), g = Array.isArray(h), u = 0, _iterator10 = g ? h : h[Symbol.iterator]() ; ;) {
                                var f;
                                if (g) {
                                    if (u >= h.length) break;
                                    f = h[u++]
                        ...
                        if (c = r.calculateObjectValue(this.options, this.options.rowAttributes, [e, t], c), c)
                            for (var x = function (e) {
                                    return Object.keys(e).map(function (t) {
                                        return [t, e[t]]
                            })
                            }(c), S = Array.isArray(x), $ = 0, _iterator11 = S ? x : x[Symbol.iterator]() ; ;) {
                                var P;
                                if (S) {
                                    if ($ >= x.length) break;
                                    P = x[$++]
                        ...
                        if (e._data && !l.isEmptyObject(e._data))
                            ...
                            }(e._data), R = Array.isArray(I), _ = 0, _iterator12 = R ? I : I[Symbol.iterator]() ; ;) {
                                var V;
                                if (R) {
                                    if (_ >= I.length) break;
                                    V = I[_++]
                                } else {
                                    if (_ = I.next(), _.done) break;
                                    V = _.value
                                }
                                var F = V,
                                    B = a(F, 2),
                        ...
                        return i.push('<tr', r.sprintf(' %s', p.length ? p.join(' ') : void 0), r.sprintf(' id="%s"', Array.isArray(e) ? void 0 : e._id), r.sprintf(' class="%s"', n.classes || (Array.isArray(e) ? void 0 : e._class)), ' data-index="' + t + '"', r.sprintf(' data-uniqueid="%s"', e[this.options.uniqueId]), r.sprintf('%s', d), '>'), this.options.cardView && i.push('<td colspan="' + this.header.fields.length + '"><div class="card-views">'), !this.options.cardView && this.options.detailView && (i.push('<td>'), r.calculateObjectValue(null, this.options.detailFilter, [t, e]) && i.push('\n            <a class="detail-icon" href="#">\n            ' + r.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen) + '\n            </a>\n          '), i.push('</td>')), this.header.fields.forEach(function (n, d) {
                            var p = '',
                                ...
                                x = '',
                                S = o.columns[d];
                            if ((!o.fromHtml || 'undefined' != typeof h || S.checkbox || S.radio) && S.visible && (!o.options.cardView || S.cardVisible)) {
                                if (S.escape && (h = r.escapeHTML(h)), s.concat([o.header.styles[d]]).length && (y = ' style="' + s.concat([o.header.styles[d]]).join('; ') + '"'), e['_' + n + '_id'] && (b = r.sprintf(' id="%s"', e['_' + n + '_id'])), e['_' + n + '_class'] && (m = r.sprintf(' class="%s"', e['_' + n + '_class'])), e['_' + n + '_rowspan'] && (v = r.sprintf(' rowspan="%s"', e['_' + n + '_rowspan'])), e['_' + n + '_colspan'] && (k = r.sprintf(' colspan="%s"', e['_' + n + '_colspan'])), e['_' + n + '_title'] && (x = r.sprintf(' title="%s"', e['_' + n + '_title'])), f = r.calculateObjectValue(o.header, o.header.cellStyles[d], [h, e, t, n], f), f.classes && (m = ' class="' + f.classes + '"'), f.css) {
                                    for (var $ = [], P = function (e) {
                                            return Object.keys(e).map(function (t) {
                                                return [t, e[t]]
                                    })
                                    }(f.css), C = Array.isArray(P), T = 0, _iterator13 = C ? P : P[Symbol.iterator]() ; ;) {
                                        var A;
                                        if (C) {
                                            if (T >= P.length) break;
                                            A = P[T++]
                                        } else {
                                            if (T = P.next(), T.done) break;
                                            A = T.value
                                        }
                                        var O = A,
                                            I = a(O, 2),
                                    ...
                                    y = ' style="' + $.concat(o.header.styles[d]).join('; ') + '"'
                                }
                                if (g = r.calculateObjectValue(S, o.header.formatters[d], [h, e, t, n], h), e['_' + n + '_data'] && !l.isEmptyObject(e['_' + n + '_data']))
                                    for (var V = function (e) {
                                            return Object.keys(e).map(function (t) {
                                                return [t, e[t]]
                                    })
                                    }(e['_' + n + '_data']), F = Array.isArray(V), B = 0, _iterator14 = F ? V : V[Symbol.iterator]() ; ;) {
                                        var N;
                                        if (F) {
                                            if (B >= V.length) break;
                                            N = V[B++]
                                ...
                                if (S.checkbox || S.radio) {
                                    ...
                                    var E = S['class'] || '',
                                        c = !0 === g || h || g && g.checked,
                                        U = !S.checkboxEnabled || g && g.disabled;
                                    p = [o.options.cardView ? '<div class="card-view ' + E + '">' : '<td class="bs-checkbox ' + E + '">', '<label>\n              <input\n              data-index="' + t + '"\n              name="' + o.options.selectItemName + '"\n              type="' + u + '"\n              ' + r.sprintf('value="%s"', e[o.options.idField]) + '\n              ' + r.sprintf('checked="%s"', c ? 'checked' : void 0) + '\n              ' + r.sprintf('disabled="%s"', U ? 'disabled' : void 0) + ' />\n              <span></span>\n              </label>', o.header.formatters[d] && 'string' == typeof g ? g : '', o.options.cardView ? '</div>' : '</td>'].join(''), e[o.header.stateField] = !0 === g || !!h || g && g.checked
                                } else if (g = 'undefined' == typeof g || null === g ? o.options.undefinedText : g, o.options.cardView) {
                                    var z = o.options.showHeader ? '<span class="card-view-title"' + y + '>' + r.getFieldTitle(o.columns, n) + '</span>' : '';
                                    p = '<div class="card-view">' + z + '<span class="card-view-value">' + g + '</span></div>', o.options.smartDisplay && '' === g && (p = '<div class="card-view"></div>')
                                } else p = '<td' + b + m + y + w + v + k + x + '>' + g + '</td>';
                                i.push(p)
                            }
                ...
                value: function (e) {
                    ...
                    for (var n = l(document.createDocumentFragment()), s = !1, d = this.pageFrom - 1; d < this.pageTo; d++) {
                        ...
                        s = s || !!c, c && 'string' == typeof c && n.append(c)
                    }
                    s ? this.$body.html(n) : this.$body.html('<tr class="no-records-found">' + r.sprintf('<td colspan="%s">%s</td>', this.$header.find('th').length, this.options.formatNoMatches()) + '</tr>'), e || this.scrollTo(0), this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (e) {
                        var o = e.currentTarget,
                            ...
                            n = l(o),
                            s = n.parent(),
                            d = l(i).parents('.card-views').children(),
                            c = l(i).parents('.card-view'),
                            p = t.data[s.data('index')],
                        ...
                        if (!n.find('.detail-icon').length && (t.trigger('click' === a ? 'click-cell' : 'dbl-click-cell', u, b, p, n), t.trigger('click' === a ? 'click-row' : 'dbl-click-row', p, s, u), 'click' === a && t.options.clickToSelect && f.clickToSelect && !r.calculateObjectValue(t.options, t.options.ignoreClickToSelectOn, [i]))) {
                            var m = s.find(r.sprintf('[name="%s"]', t.options.selectItemName));
                            m.length && m[0].click()
                        }
                    }), this.$body.find('> tr[data-index] > td > .detail-icon').off('click').on('click', function (a) {
                        a.preventDefault();
                        var e = l(a.currentTarget),
                            i = e.parent().parent(),
                            n = i.data('index'),
                            s = o[n];
                        if (i.next().is('tr.detail-view')) e.html(r.sprintf(t.constants.html.icon, t.options.iconsPrefix, t.options.icons.detailOpen)), t.trigger('collapse-row', n, s, i.next()), i.next().remove();
                        else {
                            ...
                            var d = i.next().find('td'),
                                c = r.calculateObjectValue(t.options, t.options.detailFormatter, [n, s, d], '');
                            1 === d.length && d.append(c), t.trigger('expand-row', n, s, d)
                        }
                            ...
                            if (-1 !== s) {
                                ...
                                for (var d = function () {
                                        ...
                                        t.$body.find('>tr:not(.no-records-found)').each(function (e, o) {
                                            var a = l(o),
                                                d = a.find(t.options.cardView ? '.card-view' : 'td').eq(s),
                                                c = r.indexOf(' '),
                                                p = r.substring(0, c),
                                                h = r.substring(c + 1);
                ...
                value: function (e, t, o) {
                    ...
                    if ((this.header.sortNames[n] && (s.sortName = this.header.sortNames[n]), this.options.pagination && 'server' === this.options.sidePagination && (s.pageSize = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize, s.pageNumber = this.options.pageNumber), o || this.options.url || this.options.ajax) && ('limit' === this.options.queryParamsType && (s = {
                        ...
                        sort: s.sortName,
                        order: s.sortOrder
                    }, this.options.pagination && 'server' === this.options.sidePagination && (s.offset = this.options.pageSize === this.options.formatAllRows() ? 0 : this.options.pageSize * (this.options.pageNumber - 1), s.limit = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize, 0 === s.limit && delete s.limit)), l.isEmptyObject(this.filterColumnsPartial) || (s.filter = JSON.stringify(this.filterColumnsPartial, null)), i = r.calculateObjectValue(this.options, this.options.queryParams, [s], i), l.extend(i, t || {}), !1 !== i)) {
                        ...
                        var d = l.extend({}, r.calculateObjectValue(null, this.options.ajaxOptions), {
                            ...
                            success: function (t) {
                                ...
                                a.load(o), a.trigger('load-success', o), e || a.$tableLoading.hide()
                            },
                            error: function (t) {
                                var o = [];
                ...
                key: 'trigger',
                value: function (e) {
                    for (var o, a = e + '.bs.table', i = arguments.length, n = Array(1 < i ? i - 1 : 0), s = 1; s < i; s++) n[s - 1] = arguments[s];
                    (o = this.options)[t.EVENTS[a]].apply(o, n), this.$el.trigger(l.Event(a), n), this.options.onAll(a, n), this.$el.trigger(l.Event('all.bs.table'), [a, n])
                }
            }, {
                key: 'resetHeader',
                value: function () {
                ...
                value: function () {
                    ...
                    var i = l('.focus-temp:visible:eq(0)');
                    ...
                    d.find('> *').each(function (t, o) {
                        ...
                        if (-1 !== i) {
                            ...
                            1 < p.length && (p = l(s[a[0].cellIndex]));
                    ...
                    if (this.options.showFooter && !this.options.cardView) {
                        ...
                        for (var o = this.columns, i = Array.isArray(o), n = 0, _iterator17 = i ? o : o[Symbol.iterator]() ; ;) {
                            ...
                            if (l.visible) {
                                ...
                                if (d = r.sprintf('text-align: %s; ', l.falign ? l.falign : l.align), c = r.sprintf('vertical-align: %s; ', l.valign), h = r.calculateObjectValue(null, this.options.footerStyle, [l]), h && h.css)
                ...
                value: function () {
                    var e = this;
                    if (this.$el.is(':hidden')) return void setTimeout(l.proxy(this.fitFooter, this), 100);
                    var t = this.$tableBody.get(0),
                        o = t.scrollWidth > t.clientWidth && t.scrollHeight > t.clientHeight + this.$header.outerHeight() ? r.getScrollBarWidth() : 0;
                    ...
                    i.find('> *').each(function (t, o) {
                        ...
                        if (e.options.detailView && !e.options.cardView) {
                            if (0 === t) {
                                var s = n.filter('.detail'),
                                    r = s.width() - s.find('.fht-cell').width();
                                s.find('.fht-cell').width(a.innerWidth() - r)
                            }
                            i = t - 1
                        }
                        if (-1 !== i) {
                ...
                value: function (e) {
                    for (var t = Array.isArray(e) ? e : [e], o = t, a = Array.isArray(o), i = 0, _iterator20 = a ? o : o[Symbol.iterator]() ; ;) {
                        ...
                        if (s.hasOwnProperty('id') && s.hasOwnProperty('row')) {
                            var r = this.options.data.indexOf(this.getRowByUniqueId(s.id)); -1 !== r && l.extend(this.options.data[r], s.row)
                        }
                    }
                ...
                value: function (e) {
                    for (var t = Array.isArray(e) ? e : [e], o = t, a = Array.isArray(o), i = 0, _iterator21 = a ? o : o[Symbol.iterator]() ; ;) {
                        ...
                        var s = n;
                        s.hasOwnProperty('index') && s.hasOwnProperty('row') && l.extend(this.options.data[s.index], s.row)
                    }
                    this.initSearch(), this.initPagination(), this.initSort(), this.initBody(!0)
                }
            }, {
                ...
                value: function (e) {
                    ...
                    if (e) {
                        ...
                        for (var d = this.$body.children(), c = 0; c < d.length; c++) this.expandRow_(!0, l(d[c]).data('index'))
                }
            }, {
                key: 'collapseAllRows',
                value: function (e) {
        ...
        l.BootstrapTable = p, l.fn.bootstrapTable = function (e) {
            for (var t = arguments.length, o = Array(1 < t ? t - 1 : 0), a = 1; a < t; a++) o[a - 1] = arguments[a];
            var i;
            return this.each(function (t, a) {
                var s = l(a).data('bootstrap.table'),
                    r = l.extend({}, p.DEFAULTS, l(a).data(), 'object' === ('undefined' == typeof e ? 'undefined' : n(e)) && e);
                if ('string' == typeof e) {
                    var d;
                    if (-1 === h.indexOf(e)) throw new Error('Unknown method: ' + e);
                    if (!s) return;
                    i = (d = s)[e].apply(d, o), 'destroy' === e && l(a).removeData('bootstrap.table')
                }
                s || l(a).data('bootstrap.table', s = new l.BootstrapTable(a, r))
            }), 'undefined' == typeof i ? this : i
        }, l.fn.bootstrapTable.Constructor = p, l.fn.bootstrapTable.defaults = p.DEFAULTS, l.fn.bootstrapTable.columnDefaults = p.COLUMN_DEFAULTS, l.fn.bootstrapTable.locales = p.LOCALES, l.fn.bootstrapTable.methods = h, l.fn.bootstrapTable.utils = r, l(function () {
