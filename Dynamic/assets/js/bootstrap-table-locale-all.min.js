...
(function (a, b) {
    ...
    'use strict';
    (function (a) {
        a.fn.bootstrapTable.locales['mn-MN'] = {
            formatLoadingMessage: function () {
                return 'Ачааллаж байна, түр хүлээнэ үү...'
            },
            formatRecordsPerPage: function (a) {
                return a + '   Хуудсанд харагдах бичлэгийн тоо'
            },
            formatShowingRows: function (a, b, c) {
                return 'Нийт ' + c + ' бичлэгийн ' + a + ' - ' + b + '      '
            },
            formatSearch: function () {
                return 'Хайх утга'
            },
            formatNoMatches: function () {
                return 'Таарах бичлэг олдсонгүй'
            },
            formatPaginationSwitch: function () {
                return 'Хуудаслаж харуулах эсэх'
            },
            formatRefresh: function () {
                return 'Шинэчлэх'
            },
            formatToggle: function () {
                return 'Харагдах хэлбэрийг солих'
            },
            formatColumns: function () {
                return 'Баганууд'
            },
            ...
            formatFullscreen: function () {
                return '' //Бүтэн дэлгэцээр харах
            },
            formatClearFilters: function () {
                return 'Хайх утгыг хоослох'
            }
        }, a.extend(a.fn.bootstrapTable.defaults, a.fn.bootstrapTable.locales['mn-MN'])
    })(jQuery)
});
(function (a, b) {
    if ('function' == typeof define && define.amd) define([], b);
...
(function (a, b) {
    ...
    (function (a) {
        a.fn.bootstrapTable.locales['fr-FR'] = {
            ...
            formatDuplicateAlertTitle: function () {
                return 'Doublon(s) d\xE9tect\xE9(s)!'
            },
            formatDuplicateAlertDescription: function () {
                return 'Supprimez ou changez les colonnes dupliqu\xE9es.'
            },
            formatSortOrders: function () {
                return {
                    asc: 'Croissant',
