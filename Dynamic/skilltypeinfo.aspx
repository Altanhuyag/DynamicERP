...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="panel">
            <div class="records--header">
                <div class="title fa-object-group">
                    <h3 class="h3">Ур чадварын төрөл</h3>
                </div>
                <div class="actions" style="width: 100%;">
                    <a href="#myModal" class="btn btn-rounded btn-warning" data-toggle="modal" onclick="addRow()" style="margin-left: 10px;">Шинэ ур чадварын төрлийн бүртгэл үүсгэх</a>
                </div>
            </div>
        </div>

        <div class="panel">
            <div class="records--list" data-title="Ур чадварын төрлийн жагсаалт">
                        ...
                        <table id="recordsListView" class="dataTable no-footer" aria-describedby="recordsListView_info" style="font-size: 11px; width: 100%;" role="grid">
                            ...
                            <tbody>
                                <% foreach (System.Data.DataRow rw in dtSkillTypeInfo.Rows)
                                    {
                                %>
                                <tr data-value="<%=rw["SkillTypePkID"].ToString() %>" role="row" onclick="OnRowClick(this)" class="odd">
                                        ...
                                        <div data-todoapp="item">
                                            <div class="todo--actions dropleft">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="#myModal" class="dropdown-item editRow" data-toggle="modal" data-id="<%=rw["SkillTypePkID"].ToString() %>">Засах</a>
                                                    <a href="#RemoveModal" class="dropdown-item deleteRow" data-toggle="modal" data-todoapp="del:item" data-id="<%=rw["SkillTypePkID"].ToString() %>">Устгах</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Ур чадварын төрөл</h5>      
                    ...
                    <p>
                        <div class="form-group">                                        
                            <div class="row">
                                <div class="col-md-12">
                                    <h5>Төрлийн нэр</h5>
                                    <input class="form-control" type="text" id="txtSkillTypeName" />
                                </div>          
                            </div>
                        </div>
                    </p>                                    
    ...
    <div class="modal fade" id="RemoveModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5>Энэ ур чадварын төрлийн бүртгэлийг устгах уу ?</h5>
                </div>
    ...
    <script type = "text/javascript">
        ...
        $('.editRow').on('click', function () {
            ...
            $('#txtSkillTypeName').val(document.getElementById("recordsListView").rows[rid].cells[0].innerHTML);
        ...
        function Save() {
            var SkillType = $('#txtSkillTypeName').val().trim();
            ...
            $.ajax({
                url: 'post.aspx/SaveHRMSkillTypeInfo',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    adding: act,
                    id: selid,
                    SkillTypeName: SkillType,
                }),
