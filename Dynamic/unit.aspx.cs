...
namespace Dynamic
{
    public partial class unit : System.Web.UI.Page
    {
        ...
        public DataTable List(string SearchString)
        {
            string XML = "";
            if (SearchString != "")
                XML = "<NewDataSet><BusinessObject><UnitName>" + SearchString + "</UnitName></BusinessObject></NewDataSet>";
            DataTable dt = SystemGlobals.DataBase.ExecuteQuery("spinv_UnitInfo_SEL", XML).Tables[0];
            return dt;
        }
