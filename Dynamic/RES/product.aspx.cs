...
namespace Dynamic
{
    public partial class product : System.Web.UI.Page
    {
        ...
        public DataTable List(string SearchString)
        {
            string XML = "";
            if (SearchString != "")           
                XML = "<NewDataSet><BusinessObject><ItemName>" + SearchString + "</ItemName></BusinessObject></NewDataSet>";
            DataTable dt = SystemGlobals.DataBase.ExecuteQuery("spres_ItemInfo_SEL", XML).Tables[0];
            return dt;
        }
