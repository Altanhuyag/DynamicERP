<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ordertype.aspx.cs" Inherits="Dynamic.ordertype" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="main--content">    
        <div class="panel">
    <div class="records--header">
        <div class="title fa-shopping-bag">
            <h3 class="h3">Рестораны захиалгын төрөл <a href="item.aspx" class="btn btn-sm btn-outline-info">Захиалга удирдах</a></h3>
                    ...
                    <table id="recordsListView" class="dataTable no-footer" aria-describedby="recordsListView_info" style="font-size:11px;" role="grid">
                        ...
                        <tbody>
                            <% foreach (System.Data.DataRow rw in dtSearch.Rows)
                                ...
                                <td> <a href="#" class="btn-link"><% Response.Write(rw["OrderTypeName"].ToString()); %></a> </td>                                                          
                                <td>
                                    ...
                                    <div class="todo--actions dropleft"> 
                                        ...
                                        <div class="dropdown-menu"> 
                                            <a href="#" class="dropdown-item editRow" data-id="<%=rw["OrderTypePkID"].ToString() %>">Засах</a> 
                                            <a href="#confirmDelete" class="dropdown-item deleteRow" data-message="Та уг <<%=rw["OrderTypeName"].ToString() %>> бичлэгийг устгахыг хүсэж байна уу" data-title="Анхааруулга" data-toggle="modal" data-id="<%=rw["OrderTypePkID"].ToString() %>">Устгах</a> 
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">                                    
                                    <p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5>Захиалгын төрлийн нэр</h5>
                                                <input id="txtOrderTypeName" class="form-control txtOrderTypeName" type="text" />
                                                <input id="OrderTypePkID" value="" type="hidden" />
                                            </div>                                            
...
<script type = "text/javascript">
    ...
    $('.editRow').on('click', function () {
        ...
        $("#OrderTypePkID").val(txtID);
        $.ajax({
            url: '../post.aspx/GetOrderTypeInfo',
            type: 'POST',
            data: JSON.stringify({
                OrderTypePkID: txtID,
            }),
            ...
            success: function (response) {
                ...
                $("#OrderTypePkID").val(response.d.OrderTypePkID);               
                $("#txtOrderTypeName").val(response.d.OrderTypeName);
    ...
    function SaveForm() {
        ...
        var Adding = 0;
        var OrderTypeName = $("#txtOrderTypeName").val();       
        var OrderTypePkID = $("#OrderTypePkID").val();        
        ...
        if (OrderTypeName == "") {
            ...
            $.ajax({
                url: '../post.aspx/PostOrderTypeInfo',
                type: 'POST',
                data: JSON.stringify({
                    Adding:Adding,
                    OrderTypePkID: OrderTypePkID,
    ...
    $('#confirmDelete').find('.modal-footer #confirm').on('click', function () {
        ...
        $.ajax({
            url: '../post.aspx/DeleteOrderTypeInfo',
            type: 'POST',
            data: JSON.stringify({
                OrderTypePkID: txtID,
            }),
