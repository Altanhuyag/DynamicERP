<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="positiongroup.aspx.cs" Inherits="Dynamic.Positiongroup" %>
 ...
 <link rel="stylesheet" href="assets\css\sweetalert.min.css">
        ...
        <div class="panel">
            <div class="records--header">
                <div class="title fa-object-group">
                    <h3 class="h3">Албан тушаалын бүлэг</h3>
                </div>
                <div class="actions" style="width: 100%;">
                    <a href="#myModal" class="btn btn-rounded btn-warning" data-toggle="modal" onclick="addRow()" style="margin-left: 10px;">Албан тушаалын бүлэг үүсгэх</a>
                </div>
            </div>
        </div>

        <div class="panel">
            <div class="records--list" data-title="Албан тушаалын бүлгийн жагсаалт">
                ...
                <div id="recordsListView_wrapper" class="dataTables_wrapper no-footer">
                    <div class="table-responsive">
                        <table id="recordsListView" class="dataTable no-footer" aria-describedby="recordsListView_info" style="font-size: 11px; width: 100%;" role="grid">
                            <thead>
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="recordsListView" rowspan="1" colspan="1" aria-label="Албан тушаалын бүлгийн нэр">Албан тушаалын бүлгийн нэр</th>
                            ...
                            <tbody>
                                ...
                                <tr data-value="<%=rw["PositionGroupPkID"].ToString() %>" role="row" onclick="OnRowClick(this)" class="odd">
                                    <td><%=rw["PositionGroupName"].ToString() %></td>
                                    <td>
                                        <div data-todoapp="item">
                                            <div class="todo--actions dropleft">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="#myModal" class="dropdown-item editRow" data-toggle="modal" data-id="<%=rw["PositionGroupPkID"].ToString() %>">Засах</a>
                                                    <a href="#RemoveModal" class="dropdown-item deleteRow" data-toggle="modal" data-todoapp="del:item" data-id="<%=rw["PositionGroupPkID"].ToString() %>">Устгах</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Албан тушаалын бүлэг</h5>      
                ...
                <div class="modal-body">                                    
                    <p>
                        <div class="form-group">                                        
                            <div class="row">
                                <div class="col-md-12">
                                    <h5>Албан тушаалын бүлгийн нэр</h5>
                                    <input class="form-control" type="text" id="txtPositionGroupName" />
                                </div>          
                            </div>
                        </div>
                    </p>                                    
    ...
    <div class="modal fade" id="RemoveModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5>Энэ Албан тушаалын бүлгийн бүртгэлийг устгах уу ?</h5>
                </div>
    ...
    <script type = "text/javascript">
        ...
        $('.editRow').on('click', function () {
            ...
            $('#txtPositionGroupName').val(document.getElementById("recordsListView").rows[rid].cells[0].innerHTML);
        ...
        function Save() {
            var PositionGroup1 = $('#txtPositionGroupName').val().trim();

            if (PositionGroup1 == '') {
                swal('Анхааруулга', 'Албан тушаалын бүлгийн нэрээ оруулна уу !', 'warning');
                return;
            }
                        
            $.ajax({
                url: 'post.aspx/SaveHRMPositionGroup',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    adding: act,
                    id: selid,
                    PositionGroupName: PositionGroup1,
                }),
        ...
        function Delete() {
            $.ajax({
                url: 'post.aspx/DeleteHRMPositionGroup',
                type: 'POST',
                dataType: 'json',
                data: JSON.stringify({
                    id: selid
