IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'sphrm_hrmEmployeeMovementIn_RPT')
DROP PROC sphrm_hrmEmployeeMovementIn_RPT
GO
CREATE PROC sphrm_hrmEmployeeMovementIn_RPT
(
	@XML		  NVARCHAR(MAX),
