IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'sphrm_RetiredEmployee_SEL')
DROP PROC sphrm_RetiredEmployee_SEL
GO

CREATE PROC sphrm_RetiredEmployee_SEL
(
	@XML		  NVARCHAR(MAX),
